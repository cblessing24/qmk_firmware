...
[_NAV] = LAYOUT_planck_grid(
    _______, _______, LGUI(KC_7), LGUI(KC_8), LGUI(KC_9), _______, _______, _______, _______, _______, _______, _______,
    _______, _______, LGUI(KC_4), LGUI(KC_5), LGUI(KC_6), _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, _______, _______,
    _______, _______, LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
